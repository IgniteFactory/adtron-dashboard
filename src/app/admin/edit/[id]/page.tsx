...
export default function EditCampaign() {
  ...
  useEffect(() => {
    supabaseDb.getCampaignById(id).then(camp => {
      ...
      // Load title examples from localStorage
      const saved = titleExamplesDb.get(id);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Save to Supabase (no titleExamples — column doesn't exist)
      ...
      // Save title examples to localStorage
      titleExamplesDb.set(id, titleExamples);
